<template>
  <div class="min-h-screen flex flex-col items-center">
    ...
    <p v-show="myParcels.length === 0" class="text-main-color text-sm font-semibold mt-3 text-center
    border-b border-blue-200 md:text-lg 2xl:text-xl">You currently have no parcels!</p>
    <p v-show="myParcels.length !== 0" class="text-main-color text-sm font-semibold mt-3 text-center
    border-b border-blue-200 md:text-lg 2xl:text-xl">To change parcels info or delete it click on it and choose option</p>
